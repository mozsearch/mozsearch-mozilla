...
for REFBRANCH in beta release esr153 esr140 esr128 esr115; do
...
git config remote.esr153.url || git remote add -t branches/default/tip esr153 hg::https://hg.mozilla.org/releases/mozilla-esr153
